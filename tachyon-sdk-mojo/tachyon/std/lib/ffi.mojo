...
def GLSL_std_450_op_call[op_code: Int32, RType](*args) -> RType:
    """Reserves an GLSL.std.450 OpCode call for the Tachyon compiler to replace with the actual GLSL instruction.
    
    See the GLSL.std.450 specification for the list of available OpCodes:
    https://github.com/KhronosGroup/SPIRV-Headers/blob/main/include/spirv/unified1/GLSL.std.450.h
    """
